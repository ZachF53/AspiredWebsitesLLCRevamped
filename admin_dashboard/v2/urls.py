...
from . import views_pricing, views_scans, views_site_content, views_websites
...
urlpatterns = [
    ...
    path('websites/<uuid:website_id>/guarantee-refund/',
         views_websites.website_guarantee_refund,
         name='v2_website_guarantee_refund'),
    ...
    path('droplet-checks/<uuid:check_id>/accept-integrity-baseline/',
         views_scans.droplet_check_accept_baseline,
         name='v2_droplet_check_accept_baseline'),
    ...
    path('site-content/', views_site_content.site_content_edit,
         name='v2_site_content'),
]
