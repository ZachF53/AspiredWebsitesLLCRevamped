...
A token encodes a client id + 48-hour expiry, signed with SYNC_SECRET. It is
the credential a Moonieful-referred client uses to reach /maintenance/start/
without a full portal login.
"""
